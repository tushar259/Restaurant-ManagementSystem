    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="{{route('orderlist.index')}}" >
               Ordered Foods
            </a>
          </li>
		  <li class="nav-item">
    ...
    <div class="section">
	  ...
	  <h3>CART</h3>
        ...
        <div id="images">
          ...
          <div class="row">
            <div class="col-sm-2">
              <td><img src="burger.jpg" height="100" width="200"></td>
		      <td>{{$c['pname']}}</td>
			  <td>{{$c['price']}}</td>
			  <td>{{$c['quantity']}}</td>
			  <td><a href="{{route('addremovecart.index' , $c['id'] )}}">Add/Remove Quantity</a> | <a href="{{route('deletecart.index' , $c['id'] )}}">Delete</a></td>
            </div>
